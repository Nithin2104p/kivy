...
def speak(text):  #text -> voice
    
    # python_path = r'C:\users\nithin\anaconda3\python.exe'  
...
def take_command():  # voice -> text    what is the capital of france
...
while True:
    ...
    if query=='':
        take_command()
    elif 'what is your name' in query or 'who are you' in query or 'who developed you ' in query:
        speak('i am NIVI,i was developed by Nithin and Pavithra and i was coded in python')    
    elif 'open' in query: # whatsapp
    ...
    elif "activate chat GPT" in query or "chat GPT" in query or "go to chat GPT" in query or "CHAT GPT" in query:
        speak("done sir!,activated chat GPT !")
        from gpt4 import *
